"""SEGroupProject URL Configuration
...
urlpatterns = [
    ...
    path('', views.home),
    path('displayEvents', views.displayEvents),
    path('displayEvents/footballGame', views.footballGame),
    path('displayEvents/communityService', views.communityService),
